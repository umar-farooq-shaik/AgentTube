...
const steps = [
  {
    ...
    },
    {
      ...
      description: "Get actionable insights and stratergic recommendations",
      icon: MessageSquare,
    }
];
...
},
{
  ...
  description:"Create attention-grabbing, SEO-optimized titles for your videos using Al. Maximize views with titles that resonate with your audience.",
  icon: MessageSquare,
...
{
   title: "Discuss with Your AT Agent",
      ...
      {/* Feature <Sectoion> */}
          <section className="py-20 bg-white">
            <div className="container mx-auto px-4 max-w-6xl">
              <h2 className="text-3xl font-bold text-center mb-12">Powerul Features for Content Creators</h2>
...
Join creators leveraging Al to unlock content insights 
</p>
</div> 
</section>
